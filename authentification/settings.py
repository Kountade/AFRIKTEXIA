...
SECRET_KEY = "django-insecure-pxpa20!--fyckdazmq6jib#oh&jqh8hv9r(ikg+&&=epy2j-1y"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["stock-gestion-qtpy.onrender.com",
                 "localhost", "127.0.0.1"]
...
CORS_ALLOWED_ORIGINS = [
    "https://gestion-commercial.onrender.com",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
